...
% Начальные условия
x(:, 1) = [0; 0; 0];    % Начальные значения для x1, x2, x3
...
title('y = 1(t), x0 = [0; 0; 0]');                          % Заголовок графика
...
filePath = fullfile(folderName, 'plot_2.png'); % Полный путь к файлу
try
    saveas(gcf, filePath);
